...
const RandomPixelColumnDisplaceShader = {
	...
	addGuiFolder : function (gui, pass, openFolder)
	{
		...
		let folder = gui.addFolder('Random Pixel Row/Column Displace');
		...
		folder.add(pass.uniforms.xTime, 'value', 0, 1000, 0.01).name('X-Time');
		folder.add(pass.uniforms.yTime, 'value', 0, 1000, 0.01).name('Y-Time');
