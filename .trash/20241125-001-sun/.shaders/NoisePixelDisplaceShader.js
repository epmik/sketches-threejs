	...
	fragmentShader: /* glsl */`
		...
		*/
		...
		void main()
		{
			...
			float x = v_Uv.x + (p.x * (minXOffset + ((maxXOffset - minXOffset) * summedSimplexNoise(gl_FragCoord.xy * multiplier.x))));
			float y = v_Uv.y + (p.y * (minYOffset + ((maxYOffset - minYOffset) * summedSimplexNoise((gl_FragCoord.xy  + vec2(8.2146, 3.5964)) * multiplier.y))));
