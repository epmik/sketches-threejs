...
function init() 
{
    ...
    // console.log(noise2D(0.125, 1.246));

    // console.log(THREE.MathUtils.seededRandom(1)); // returns 0.000007825903601782307
    // console.log(THREE.MathUtils.seededRandom(10)); // returns 0.00007826322696941274
    // console.log(THREE.MathUtils.seededRandom(100)); // returns 0.0007826364606457171
    // console.log(THREE.MathUtils.seededRandom(1000)); // returns 0.00782636879740876
    ...
    for ( let i = 0, l = divisions2; i < l; i ++ ) {
        ...
        positions2.push( t * 100, -4 + THREE.MathUtils.seededRandom() * 8, -4 + THREE.MathUtils.seededRandom() * 8);
        color2.setHSL(THREE.MathUtils.seededRandom(), 1.0, 0.5, THREE.SRGBColorSpace );
    ...
    // const line2 = new Line2( geometry2, matLine2 );
